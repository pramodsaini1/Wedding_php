...
<div class="ss_congratulations" style="margin-top:10%">
		<center><div class="font_24"><h2>Watch the beautiful journey of our Success Stories and be inspired.</h2></div></center>
	</div><br><br><br><br>
       
                <div class="container-fluid" style="background-color:#F0F3EB">
	                <div class="row">
					      <div class="col-sm-4" >
						   <center><img src="images/26.jpg" class="img-fluid"></center>
						  </div>
	                      <div class="col-sm-4" >
						  	 <div class="w3-card" style="width:400px" class="card bg-light text-dark">
								<div class="card-body">
								<iframe src="https://www.youtube.com/embed/QZbwu95eYHE" autoplay="1" frameborder="0" allowfullscreen></iframe>
						  	 ...
						  	 <div class="w3-card" style="width:400px" class="card bg-light text-dark">
								<div class="card-body">
 				                <iframe src="https://www.youtube.com/embed/95qPaIqLK8A" autoplay="1" frameborder="0" allowfullscreen></iframe>
				                  <div class="spacer_5"></div>
				                     <h2>Humaira & Vasim	</h2>
                                  </div>
                               </div>
						  ...
						  <div class="row ">
						    <div class="col-sm-4">
													   <center><img src="images/23.jpg" class="img-fluid"></center>
							</div>
	                      <div class="col-sm-4" >
						  	 <div class="w3-card" style="width:400px" class="card bg-light text-dark">
								<div class="card-body">
				                 <iframe src="https://www.youtube.com/embed/L_GgJZbPZus" autoplay="1" frameborder="0" allowfullscreen></iframe>
				                  <div class="spacer_5"></div>
				                     <h2>Anushree & Nitin</h2>
                                  </div>
                               </div>
                            </div>							   
                                   <div class="col-sm-4" >
						  	 <div class="w3-card" style="width:400px" class="card bg-light text-dark">
								<div class="card-body">
				                  <iframe src="https://www.youtube.com/embed/jczNUPS1cMI" autoplay="1" frameborder="0" allowfullscreen></iframe>
				                  <div class="spacer_5"></div>
				                     <h2>Dhruti & Kiran	</h2>
                                  </div>
                               </div>
