	   ...
	   <div class="row">
	       <div class="col-sm-6" style="background-color:white">
		          <div class="w3-card" style="width:600px" class="card bg-light text-dark">
				     	   <img src="images/8.jpg" class="img-fluid" class="card-img-top" alt="Card image" style="width:100%" >
				     <div class="card-body">
					        <h2 class="card-title">Vivek & Anubhuti</h2>
							<div>
Our parents talked over Jeevansathi.com after we mutually liked each other, that was the first step towards our success story & we are very thankful for such a wonderful concept Jeevansathi.com has. Then finally i met Anubhuti with family in orchha & that was the moment when i felt that i found my true companion & better of half of my life. Thanks again Jeevansathi.com</div><br><br><br>
							 <div class="ss_footer">
							<div class="ss_story_line"></div>
						"Jeevansathi.com Team congratulates <span>Vivek &amp; Anubhuti</span>. We wish you both a happy future."	</div>
					  </div>
					</div>
 	        </div>
			<div class="col-sm-6">
